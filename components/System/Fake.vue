<template>
  <section class="fake">
    <div class="container">
      <h2>КАК ВЫГЛЯДИТ ПОДДЕЛКА</h2>
      <div class="fake__slider">
        <vue-tiny-slider v-bind="sliderOptions" ref="fakeSldier">
          <div v-for="item in items" class="fake__item">
            <div class="fake__row">
...
export default{
  data: () => ({
    sliderOptions: {
      ...
      navPosition: 'bottom',
      nav: true,
      navContainer: '#fake__nav',
      prevButton: `.fake__btn-prev`,
      nextButton: `.fake__btn-next`,
    },
    items: [
      {
        img: 'systems-img1.png',
        txt: '1 Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque commodo vulputate metus, vel facilisis diam mattis vitae. Aliquam elit tortor, pretium id pharetra non',
      },
      {
        img: 'systems-img1.png',
        txt: '2 Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque commodo vulputate metus, vel facilisis diam mattis vitae. Aliquam elit tortor, pretium id pharetra non',
      },
      {
        img: 'systems-img1.png',
        txt: '3 Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque commodo vulputate metus, vel facilisis diam mattis vitae. Aliquam elit tortor, pretium id pharetra non',
      },
    ]
  })
}
